...
export function BrandMark({ 
  ...
  return (
    <div className="relative flex-shrink-0" style={{ width: size, height: size }}>
      <div className={cn(
        "absolute inset-0 rounded-full border-[4px]",
        ringColorMap[ringColor]
      )} />
      <div 
        className="absolute w-2 h-2 rounded-full bg-gold top-[-1px] left-1/2 -translate-x-1/2"
      />
    </div>
  )
}
...
export function TopBar({ onSettings }: { onSettings?: () => void }) {
  return (
    <div className="flex items-center justify-between px-[22px] pt-[54px] pb-[6px]">
...
const MEDAL_CONFIG = {
  distance: { 
    m1: "#E0402A", m2: "#F2C14E", 
    core: "#1E3A30", glyph: "#E8A93C", 
    Icon: Route 
  },
  consistency: { 
    m1: "#E8A93C", m2: "#fff3d6", 
    core: "#B7301E", glyph: "#F3EEE3", 
    Icon: Flame 
  },
  pace: { 
    m1: "#1E3A30", m2: "#4f8d6f", 
    core: "#E8A93C", glyph: "#1E3A30", 
    Icon: Zap 
  },
  community: { 
    m1: "#B7301E", m2: "#E8A93C", 
    core: "#2C4E41", glyph: "#E8A93C", 
    Icon: Users 
  },
  monthly: { 
    m1: "#2C4E41", m2: "#E8A93C", 
    core: "#E0402A", glyph: "#F3EEE3", 
    Icon: Calendar 
  },
  special: { 
    m1: "#E8A93C", m2: "#E0402A", 
    core: "#1B1916", glyph: "#E8A93C", 
    Icon: Crown 
  },
}
...
export function PacelineMedal({ 
  ...
  const config = MEDAL_CONFIG[category]
...
export function PacelineProgress({ 
  ...
  return (
    <div 
      className={cn("pl-prog", onPine && "pl-prog-onpine")} 
      style={{ height }}
    >
      <div 
      ...
      <div className="bg-card border border-line rounded-3xl shadow-lg flex items-center justify-between px-2 py-2 gap-[2px]">
        {navItems.slice(0, 2).map((item) => (
          ...
          >
            ...
            <span className="mono text-[9px] tracking-[0.06em] uppercase font-semibold">
              {item.label}
            </span>
          </a>
        ))}
